...
function roots_scripts() {
	wp_enqueue_style('roots_bootstrap_style', get_template_directory_uri() . '/css/foundation.css', false, null);
	/*David*/
	...
	/*wp_register_script('roots_main', get_template_directory_uri() . '/js/vendor/jquery.js', false, null, false);
	wp_register_script('roots_main', get_template_directory_uri() . '/js/foundation.min.js', false, null, false);
	wp_register_script('roots_main', get_template_directory_uri() . '/js/foundation/foundation.topbar.js', false, null, false);*/

...
function roots_widgets_init() {
	...
	register_widget('ETV_Video_Categories_Widget');
	register_widget('ETV_Video_Tags_Widget');
}
 ...
 */
class ETV_Video_Categories_Widget extends soilWidget {
  function __construct() {
    $this->defaults = array(
      'title' => __('Video Categories', 'roots')
    );

    parent::__construct('widget_etv_video_categories', __('&nbsp;ETV: Video Categories', 'roots'), array(
      'description' => __('Use this widget to show video catetories', 'roots')
    ));
  }
  ...
  function content($instance) {
    ...
    echo '<ul><li><a href="/videos/">All</a></li>';
 ...
 * Video Tags Widget
 */
class ETV_Video_Tags_Widget extends soilWidget {
  function __construct() {
    $this->defaults = array(
      'title' => __('Video Tags', 'roots')
    );

    parent::__construct('widget_etv_video_tags', __('&nbsp;ETV: Video Tags', 'roots'), array(
      'description' => __('Use this widget to show video tag cloud', 'roots')
    ));
  }
  ...
  function content($instance) {
	...
	$tax_terms = get_terms($taxonomy);
    echo '<a class="allTags" href="/videos/">include all tags</a><div class="TagCloud">';
    foreach ($tax_terms as $tax_term) {
		echo '<span>' . '<a href="' . esc_attr(get_term_link($tax_term, $taxonomy)) . '" title="' . sprintf( __( "View all posts in %s" ), $tax_term->name ) . '" ' . '>' . $tax_term->name.'</a></li>';
	}
